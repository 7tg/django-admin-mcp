...
class TestCRUDOperations:
    ...
    async def test_create_author(self):
        ...
        result = await MCPAdminMixin.handle_tool_call('create_author', {
            'data': {
                'name': 'Test Author',
    ...
    async def test_update_author(self):
        ...
        result = await MCPAdminMixin.handle_tool_call('update_author', {
            'id': author.id,
    ...
    async def test_create_article_with_author(self):
        ...
        result = await MCPAdminMixin.handle_tool_call('create_article', {
            'data': {
                'title': 'Test Article',
