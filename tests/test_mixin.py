...
class TestMCPAdminMixin:
    ...
    def test_tools_generated_for_author(self):
        ...
        expected_tools = ['list_author', 'get_author', 'create_author', 'update_author', 'delete_author']
    ...
    def test_tools_generated_for_article(self):
        ...
        expected_tools = ['list_article', 'get_article', 'create_article', 'update_article', 'delete_article']
        assert tool_names == expected_tools, f"Expected {expected_tools}, got {tool_names}"
